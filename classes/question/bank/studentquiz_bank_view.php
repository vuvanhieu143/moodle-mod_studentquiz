...
class studentquiz_bank_view extends \core_question\local\bank\view {
    ...
    protected function build_query(): void {
        ...
        $joins = [
                ...
                'qr' => "JOIN {question_references} qr ON qr.questionbankentryid = qbe.id AND qr.version = qv.version",
        ...
        $tests = [
                ...
                "qr.component = '" . STUDENTQUIZ_COMPONENT_QR . "'",
                "qr.questionarea = '" . STUDENTQUIZ_QUESTIONAREA_QR . "'",
                $latestversion
        ];
