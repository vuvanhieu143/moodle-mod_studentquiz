...
function mod_studentquiz_load_studentquiz_question($questionid, $studentquizid) {
    global $DB;
    $sql = 'SELECT sqq.*
              FROM {studentquiz} sq
             ...
             WHERE q.id = :questionid AND sq.id = :studentquizid;
    ';
    return $DB->get_record_sql($sql, ['questionid' => $questionid, 'studentquizid' => $studentquizid]);
}
